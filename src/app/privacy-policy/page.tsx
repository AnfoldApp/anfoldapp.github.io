  ...
  return (
    <Layout>
      <section className="content-section flex flex-col text-base p-6">
        ...
        <p className="text-base opacity-75">Effective Date: July 31st, 2025</p>

        <h5>1. Introduction</h5>
        <p>
          Welcome to Anfold, an AI-powered nutrition and exercise journal
          designed to help you track meals, workouts, and wellbeing notes. Your
          privacy is important to us, and we are committed to protecting your
          personal data. This Privacy Policy explains what data we collect, how
          we use it, and how we keep it secure when you use our app.
        </p>

        <h5>2. Data Controller</h5>
        <p>
          Anfold is operated by Avocado Technologies UG (haftungsbeschränkt), a
          company based in Berlin, Germany.
        </p>

        <h5>3. Types of Personal Data Collected</h5>
        <p>
        ...
        <ul>
          ...
          <li>
            <strong>Health & Nutrition Data:</strong> Meals logged, ingredients,
            exercise activities, wellbeing notes, and other health-related
            entries you provide.
          </li>
          <li>
            <strong>Device Information:</strong> Device type, operating system,
            unique device identifiers, and mobile network details.
          </li>
          <li>
          ...
          <li>
            ...
            app performance, remember preferences, and enhance your experience.
          </li>
        </ul>

        <h5>4. Purposes of Data Collection</h5>
        ...
        <h5>5. Data Storage and Retention</h5>
        <p>
          Your data is stored securely on servers located in the European Union.
          We retain your data only as long as needed to provide Anfold&apos;s
          services and fulfill the purposes outlined in this policy, unless
          longer retention is required by law. You can request deletion or
          anonymization of your data at any time, subject to legal obligations.
        </p>
        ...
        <h5>8. Data Processing with Third Parties</h5>
        <p>
          ...
          (haftungsbeschränkt) has entered into a Data Processing Addendum with
          OpenAI Ireland Ltd. to process certain app data securely and in
